...
Int_t cef3Scan::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cef3Scan::LoadTree(Long64_t entry)
{
...
void cef3Scan::Show(Long64_t entry)
{
...
Int_t cef3Scan::Cut(Long64_t entry)
{
